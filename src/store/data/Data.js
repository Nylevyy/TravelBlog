...
export const appStoreAPI = {
  ...
  POST(article) {
    ...
    return new Promise((resolve) =>
      setTimeout(() => resolve(JSON.stringify(this._articles)), 1000)
    );
  },
  PUT(json) {
    ...
    return new Promise((resolve) =>
      setTimeout(() => resolve(JSON.stringify(this._articles)), 800)
    );
  },
  DELETE(id) {
    ...
    return new Promise((resolve) =>
      setTimeout(() => resolve(JSON.stringify(this._articles)), 700)
    );
  },
};
